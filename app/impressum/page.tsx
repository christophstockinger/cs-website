...
export interface IImprintPageProps {}

const ImprintPage = ({}: IImprintPageProps) => {
  return (
    <Grid as="div">
      <Section className="col-span-full">
        ...
        <Text className="mt-12 lg:mt-16">
          <Headline as="h2" variant="lg" color="black" className="mb-4">
            Angaben gemäß §5 TMG
          </Headline>
          <Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Manuel MaierChristoph Stockinger
          </Paragraph>
          <Paragraph>
            <strong>Registereintrag:</strong>
            <br />
            Amtsgericht PassauHandelsregister: HRB 11776
          </Paragraph>
          <Paragraph>
            <strong>
